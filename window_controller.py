...
class WindowController:
    def __init__(self):
        ...
        try:
            ...
            if scrcpy is None:
                raise ImportError("scrcpy package is not installed. Run: pip install scrcpy-python")
            ...
            try:
                self.FRAME_STALE_TIMEOUT = float(load_toml_as_dict("cfg/general_config.toml").get("stale_frame_timeout_s", 15))
